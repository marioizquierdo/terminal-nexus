...
| Commander Army selection | GATED | The real Citizens-versus-Ravels roster, costs, timings, and upgrade pool the retired Milestone 4 owned. Still reserved: `commander-armies.md` Section 1 and `AGENTS.md` Section 2 are unchanged, and Q34 draws the exact line between that and the single named Commander Milestone 8 builds for PERIMETER | Select the deliberately tiny integrated ruleset once enough levels justify committing to it |
